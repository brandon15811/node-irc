...
Client.prototype._addWhoisData = function(nick, key, value, onlyIfExists) {
    ...
    nickIndex = nick.toLowerCase();
    this._whoisData[nickIndex] = this._whoisData[nickIndex] || {nick: nick};
    this._whoisData[nickIndex][key] = value;
};
...
Client.prototype._clearWhoisData = function(nick) {
    ...
    var data = this._whoisData[nickIndex];
    delete this._whoisData[nickIndex];
    return data;
};
